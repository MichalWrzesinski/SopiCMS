                        ...
                        <div id="section-1-container" class="accordion-collapse collapse show" aria-labelledby="section-1">
                            <section class="accordion-body p-4">
                                ...
                                <form method="post" action="{{ route('user.manage.data.send') }}">
                                    ...
                                    <div class="mt-4">
                                        <input type="submit" value="{{ __('user.button.submit') }}" class="btn btn-primary">
                                    </div>
                                </form>
                            </section>
                        </div>
                            ...
                            <section class="accordion-body p-4">
                                <form method="post" action="{{ route('user.manage.password.send') }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <label>
                                                {{ __('user.field.passwordConfirmation') }}
                            ...
                            <section class="accordion-body p-4">
                                @if($user->avatar)
                                    <form method="post" action="{{ route('user.manage.avatar.delete') }}">
                                        ...
                                        <button type="submit" class="btn btn-primary">{{ __('user.button.deleteAvatar') }}</button>
                                    </form>
                                    <h2 class="mt-5">{{ __('user.header.avatarNew') }}</h2>
                                @endif
